...
const JOBS: Job[] = [
    {
        ...
        tags: ["TypeScript", "React", "Python", "Go", "Django REST", "PostgreSQL", "GCP", "Azure", "Terraform", "RAG", "Docker"],
        overview:
        ...
        details: [
            ...
            "Shipped several internal accounting automation tools, reconciliation apps, client reporting dashboards - independently from spec to production",
            "Created a transcription pipeline using Kafka to get all recorded meetings and transcribe them into meeting notes",
            "Provisioned and maintained CI/CD infrastructure across GCP and Azure using Terraform",
            "Worked directly with stakeholders across the firm to scope requirements and iterate on tooling",
            "Built an internal Prompt Library to standardise and share LLM workflows across the firm",
        ],
    },
    {
        id:      "exp-jlr",
        ...
        role:    "Software Engineer – VITAL V&V · Gaydon",
        period:  "2022 – 2023",
        bullets: [
            "Ran HIL rig tests against live ECU signals on the VITAL platform",
            "Created HIL rigs from scratch",
        ...
        details: [
            "Executed Hardware-in-the-Loop test sequences using dSPACE rigs and AutomationDesk, validating ECU behaviour against feature specifications for body electronics modules",
            "Used MATLAB and Simulink to inspect captured signal traces and to compare measured ECU responses against expected behaviour",
            "Supported rig setup and reconfiguration alongside senior engineers, wiring changes, dSPACE model deployment and HIL environment maintenance",
